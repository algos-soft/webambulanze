...
<a href="#edit-versione" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="edit-versione" class="content scaffold-edit" role="main">
    <h1><g:message code="versione.edit.label" default="Modifica versione"/></h1>
    <g:if test="${flash.message}">
        <div class="message" role="status">${flash.message}</div>
    </g:if>
    <g:hasErrors bean="${versioneInstance}">
        <ul class="errors" role="alert">
            <g:eachError bean="${versioneInstance}" var="error">
    ...
    <g:hiddenField name="version" value="${versioneInstance?.version}"/>
    <fieldset class="form">
