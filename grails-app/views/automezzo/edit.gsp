...
<a href="#edit-automezzo" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="edit-automezzo" class="content scaffold-edit" role="main">
    <h1><g:message code="automezzo.edit.label" default="Modifica automezzo"/></h1>
    <g:if test="${flash.message}">
        <div class="message" role="status">${flash.message}</div>
    </g:if>
    <g:hasErrors bean="${automezzoInstance}">
        <ul class="errors" role="alert">
            <g:eachError bean="${automezzoInstance}" var="error">
    ...
    <g:hiddenField name="version" value="${automezzoInstance?.version}"/>
    <fieldset class="form">
